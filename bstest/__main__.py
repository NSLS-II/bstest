...
def parse_args():
    ...
    parser.add_argument('-d', '--debug', action='store_true',
                        help='enables debug logging, shows local variables in tracebacks')

    parser.add_argument('-q', '--quiet', action='store_true',
                        help='less verbose output')

    parser.add_argument('-i', '--ignorewarnings', action='store_true',
                        help='suppresses warning messages generated by pytest')
...
def main():
    ...
    if args['ignorewarnings']:
        pytest_args.append('--disable-pytest-warnings')
